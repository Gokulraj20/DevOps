...
resource "aws_subnet" "private_app_subnet_az1" {
  vpc_id                   = aws_vpc.vpc.id
  cidr_block               = var.private-app-subnet-az1-cidr
  availability_zone        = data.aws_availability_zones.available_zones.names[0]
...
resource "aws_subnet" "private_app_subnet_az2" {
  vpc_id                   = aws_vpc.vpc.id
  cidr_block               = var.private-app-subnet-az2-cidr
  availability_zone        = data.aws_availability_zones.available_zones.names[1]
  map_public_ip_on_launch  = false
...
resource "aws_subnet" "private_db_subnet_az1" {
  vpc_id                   = aws_vpc.vpc.id
  cidr_block               = var.private-db-subnet-az1-cidr
  availability_zone        = data.aws_availability_zones.available_zones.names[0]
  map_public_ip_on_launch  = false
...
resource "aws_subnet" "private_db_subnet_az2" {
  vpc_id                   = aws_vpc.vpc.id
  cidr_block               = var.private-db-subnet-az2-cidr
  availability_zone        = data.aws_availability_zones.available_zones.names[1]
  map_public_ip_on_launch  = false
